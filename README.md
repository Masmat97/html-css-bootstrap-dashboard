DESCRIZIONE
Ricreiamo il layout responsive di una dashboard, ovvero il pannello di controllo di una ipotetica applicazione web, seguendo gli screenshot allegati. Dovrete utilizzare Bootstrap 5.
...
MILESTONES
Cercate di creare più commit, uno per ogni sezione/funzionalità aggiunta. Ad esempio: layout a blocchi, header, sidebar ecc..
CONSIGLI
In caso di dubbi riguardate il materiale allegato e il record di questa mattina con la traccia
